...
class PuzzleState:
    ...
    def get_neighbors(self):
        neighbors = []
        row, col = divmod(self.zero_index, 4)
        moves = {
            'UP': (row - 1, col),
            'DOWN': (row + 1, col),
            'LEFT': (row, col - 1),
...
def heuristic(board, goal):
    ...
    for i, value in enumerate(board):
        ...
        distance += abs(goal_index // 4 - i // 4) + abs(goal_index % 4 - i % 4)
    return distance
...
class PuzzleApp(QWidget):
    ...
    def init_ui(self):
        ...
        title_label.setStyleSheet("font-size: 24px; font-weight: bold; color: #2E3B4E; padding-bottom: 20px;")
        ...
        self.algorithm_selector.setStyleSheet(
            "font-size: 16px; color: white; padding: 5px; background-color: #2E3B4E;")  # White text and dark background
        ...
        self.status_label.setStyleSheet("font-size: 16px; color: #2E3B4E; padding-top: 20px;")
        layout.addWidget(self.status_label)

        self.timer_label = QLabel("Time Elapsed: 0s")
        self.timer_label.setAlignment(Qt.AlignCenter)
        self.timer_label.setStyleSheet("font-size: 16px; color: #2E3B4E; padding-top: 10px;")
    ...
    def solve_puzzle(self):
        ...
        if solution:
            ...
            self.status_label.setStyleSheet("font-size: 16px; color: #F44336;")  # Red color for error
...
if __name__ == '__main__':
    ...
    puzzle_app = PuzzleApp(initial_board, goal_board, algorithm_type)
    sys.exit(app.exec_())
